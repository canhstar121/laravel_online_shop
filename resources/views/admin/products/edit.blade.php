                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        placeholder=""  value="{{ $product->short_description }}"></textarea>
                                    </div>
                                </div>      
                                <div class="col-md-12">
                                    <div class="mb-3">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        placeholder=""  value="{{ $product->shipping_return }}"></textarea>
                                    </div>
                                </div>                                                                                
                            </div>
                        </div>	                                                                      
                ...
                <div class="col-md-4">
                    ...
                    {{-- <div class="card mb-3">
                        <div class="card-body">	
                            ...
                            <div class="mb-3">
                                <select class="related-product w-100" name="related_products" id="related_products"></select>
                                <p class="error"></p>
                            </div>
                        </div>
                    </div>  --}}
